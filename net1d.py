...
class BasicBlock(nn.Module):
    ...
    output: (n_sample, out_channels, (n_length+stride-1)//stride)
    """
    def __init__(self, in_channels, out_channels, ratio, kernel_size, stride, groups, downsample, is_first_block=False, use_bn=True, use_do=True, dropout_rate=0.5):
...
class BasicStage(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, ratio, kernel_size, stride, groups, i_stage, m_blocks, use_bn=True, use_do=True, verbose=False, dropout_rate=0.5):
...
class Net1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, ratio, filter_list, m_blocks_list, kernel_size, stride, groups_width, min_label=21, max_label=100, n_classes=1, use_bn=True, use_do=True, verbose=False, dropout_rate=0.5):
        ...
        self.n_labels = max_label - min_label + 1
        ...
        self.dense = nn.Sequential(
            ...
            nn.Linear(in_channels // 4, n_classes)
        )
    ...
    def extract_last_conv_features(self, x):
